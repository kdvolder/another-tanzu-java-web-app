...
```json
{
  "projectName" : "another-tanzu-java-web-app",
  "repositoryPrefix" : "dev.registry.tanzu.vmware.com/app-live-view/test"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->another-tanzu-java-w...(truncated)]
